...
if args.data_name == 'celeba':
    ...
    data_set = PublicCeleba(file_path='../../../PLG-MI-Attack-main/data_files/celeba_ganset.txt',
    ...
    data_set = PublicFaceScrub(file_path='../../../PLG-MI-Attack-main/data_files/facescrub_ganset.txt',
